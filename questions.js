var questions = [
    {
        title: "How would you refer to the 'font-size' property in javascript?",
        choices: ["font-size", "fontSize", "font.size", "$(font-size)"],
        answer: "fontSize"
    },
    {
        title: "What do we call the set of rules applied to CSS selectors in order to determine which style is applied to an element?",
        choices: ["scope", "peculiarity", "specificity", "range"],
        answer: "specificity"
    },
    {
